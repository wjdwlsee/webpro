...
// printWriter : OutputStream을 기본스트림으로 하는 보조스트림으로 사용(1)
// printWriter : Writer를 기본스트림으로 하는 보조 스트림으로 사용(2)
// printWrtier 혼자 기본스트림처럼 사용(3)
public class Ex {
...
//			printWriter = new PrintWriter(writer);
			...
			printWriter = new PrintWriter("txtFile/outTest.txt"); // append불가
			// 콘솔 및 파일 출력
