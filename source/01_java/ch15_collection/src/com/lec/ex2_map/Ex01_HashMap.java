...
public class Ex01_HashMap {
	...
	System.out.println(11+"key값의 데이터는" + hashmap.get(11)); //데이더를 가져올떄는 get
	System.out.println(22+"key값의 데이터는" + hashmap.get(22)); //해당key값이 없으면 null
	hashmap.remove(33); //remove시 key값으로 제거
	System.out.println("33key제거 후" + hashmap);
	System.out.println(hashmap.isEmpty()?"데이터 없음" : "데이터 있음");
	hashmap.clear();//hashmap 데이터 모두 제거
	...
	while(iterator.hasNext()) {
		...
		System.out.println(key + "키의 데이더는" + hashmap.get(key));
