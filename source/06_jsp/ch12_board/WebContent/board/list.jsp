...
<body>
	<%--//writeBoard 수행후 list로 오면 result 파라미터 존재
		...
		if(result!=null && result.equals("1")){
			...
			out.print("<script>alert('글쓰기실패(길어)')</script>");
		}
	--%>
	<table>
		<caption>게시판</caption>
		<tr><td><a href ="<%=conPath%>/board/writerForm.jsp">글쓰기</a></td></tr>
	</table>
	<table>
		<tr><th>글번호 </th><th>작성자 </th><th>글제목</th><th>메일 </th><th>조회수</th></tr>
		<%
		BoardDao bDao = BoardDao.getInstance();
		int totalCnt = bDao.getBoardTotalCnt(); //글전체 갯수
		if(totalCnt == 0){
