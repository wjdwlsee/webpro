...
<body>
	...
	<h3>request 내 attribute ${request.requestName }</h3>
	<h3>session 내  attribute:${session.sessionName} </h3>
	<h3>application 내 attribute ${application.applicationName }</h3>
	<hr>
	<h3>페이지 내 attribute ${pageName }</h3>
	<h3>request 내 attribute ${requestName }</h3>
	<h3>session 내  attribute:${sessionName} </h3>
	<h3>application 내 attribute ${applcationName }</h3>
