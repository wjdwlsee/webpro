...
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT, BFILENAME, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '홍', '글1', '',NULL, MVC_BOARD_SEQ.CURRVAL, 0,0, '192.1.1.1');--글1
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT,BFILENAME, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '홍', '글2', NULL,NULL, MVC_BOARD_SEQ.CURRVAL, 0,0, '192.1.1.2');--글2
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT,BFILENAME, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '답돌이', '글2-1(글3)', NULL, 'a.txt', 2, 1, 1, '192.1.1.2'); -- 글2의 첫번째답(글3)
...
-- 3. 원글쓰기 id=boardWrite
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT, BFILENAMe, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '김', '글3', NULL, null, MVC_BOARD_SEQ.CURRVAL, 0,0, '192.1.1.2');
...
INSERT INTO MVC_BOARD (BID, bNAME, bTITLE, BCONTENT, BFILENAME, BGROUP, bSTEP, BINDENT, BIP)
  VALUES (MVC_BOARD_SEQ.NEXTVAL, '김', '글3의 답', '본문','a.txt', 2, 2, 2, '192.1.1.1');
COMMIT;
SELECT * FROM MVC_BOARD ORDER BY BGROUP DESC, BSTEP; -- 확인