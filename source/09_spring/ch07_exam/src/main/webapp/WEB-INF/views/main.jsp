...
<body>
	...
	<p><button onclick="loction.href='${conPath }/member?method=login'">로그인</button></p>
	<p><button onclick="loction.href='${conPath }/member?method=logout'">로그아웃</button></p>
	<p><button onclick="loction.href='${conPath }/member?method=modify'">수정</button></p>
